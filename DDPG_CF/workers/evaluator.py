...
def run(conf=None, actors=None,
    ...
    for typ, input_list in input_opts.items(): # allows for a variety of input responses for simulation.
        ...
        states_axs[num_rows-1].plot(input_list, label=f"Standard deviation", zorder=0) # overlay platoon leaders transmitted data
        ...
        reward_axs[number_of_reward_components-2].plot(input_list, label=f"Standard deviation", zorder=0) # overlay platoon leaders transmitted data
        ...
        sim_axs[num_rows-2].plot(input_list, label=f"Standard deviation", zorder=0, linewidth=plot_lwidth) # overlay platoon leaders transmitted data
